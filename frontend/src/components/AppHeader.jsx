 ...
 * App Header
 * ----------
 * This module renders the top navigation header displayed across the application.
 *
 * What it renders:
 * - A brand section with an icon mark and product title.
 * - Primary navigation links to the main pages (Dashboard and Recurring).
 * - Secondary placeholder actions (Your Account and Resources) for future expansion.
 *
 * How it works:
 * - NavLink determines the active route using useLocation and applies active styling when the
 *   current pathname matches the link target.
 * - LogoMark renders a simple inline SVG mark for consistent branding without external assets.
 */
    ...
    <header className="flex items-center justify-between gap-4 rounded-2xl border border-slate-800/60 bg-slate-950/30 px-4 py-3 backdrop-blur-xl">
      <div className="flex items-center gap-3">
        ...
        <div className="leading-tight">
          <div className="text-base font-extrabold tracking-tight text-white">Smart Financial Coach</div>
          <div className="text-xs text-slate-400">Own Your Wealth</div>
        </div>
      </div>
